...
using Survey.Api.Models.Survey_Response_Models;
...
#warning Need to fix all the base client implimentation for logging and checking
    public class SurveyResponseController : ControllerBase
    {
        ...
        public async Task<ActionResult<Logic.Objects.Response>> PutSurveyResponse(Guid surveyResponseID, ApiSurveyReponseText model)
        {
            /*
